...
// import { COLORS, STROKE, OPACITY, CLASSES } from "./constants";
// 
...
//   const href = `#${section}` as const; // Gera o href dinâmico exigido pelo tipo
// 
//   return (
//     <Hotspot
//       href={href}
...
//         className={`${CLASSES.stroke} group-hover:opacity-(--opacity-hover,1)`}
//       />
// 
